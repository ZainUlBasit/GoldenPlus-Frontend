...
import { UpdateBranchApi } from "../../Https";

const EditBranchModal = ({ OpenModal, setOpenModal, branch }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { name, email, branch_number } = formData;

    if (!name || !email || !branch_number) {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        dispatch(fetchBranches()); // Ensure you have a function to fetch branch data
        setOpenModal(false);
      } else {
  ...
  return (
    <ModalWrapper open={OpenModal} setOpen={setOpenModal} title={"Edit Branch"}>
